...
class ASRDaemonClient:
    ...
    def __init__(self, base_dir: Path, num_workers: int = 4, model_size: str = "base", device: str = "cpu"):
    ...
    def start_daemon(self):
        ...
        logging.info(f"Starting ASR daemon with {self.num_workers} workers (model: {self.model_size}, device: {self.device})...")
        ...
        # Open log file and redirect daemon stdout/stderr to it
        self.daemon_log_file = open(log_file, 'w', buffering=1)  # Line buffered
