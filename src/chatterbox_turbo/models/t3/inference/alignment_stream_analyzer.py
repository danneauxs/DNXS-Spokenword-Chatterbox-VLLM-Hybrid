...
class AlignmentAnalysisResult:
    """Represents the result of alignment analysis for a frame, indicating various potential issues and completion status. Attributes include flags for false start, long tail, repetition, discontinuity, and completion status, as well as an approximate position in the text token sequence."""
...
class AlignmentStreamAnalyzer:
    """Class for analyzing text-speech alignment in streaming TTS models using a hook injected into an attention layer. Heuristics are used to determine alignment position and repetition."""
    ...
    def _add_attention_spy(self, tfmr, alignment_layer_idx):
        ...
        def patched_forward(self, *args, **kwargs):
            ...
            Args:
            logits: The logits before modification.
            Returns:
            None
            """
