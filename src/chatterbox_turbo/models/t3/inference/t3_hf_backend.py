...
class T3HuggingfaceBackend(LlamaPreTrainedModel, GenerationMixin):
    ...
    def __init__(
        ...
        *,
        ...
        llama (LlamaModel): The neural network model.
        speech_enc: Speech encoder component.
        speech_head: Speech processing head.
        latents_queue: Queue for storing latent states.
        logits_queue: Queue for storing logits.
        alignment_stream_analyzer: Alignment stream analyzer.
        """
