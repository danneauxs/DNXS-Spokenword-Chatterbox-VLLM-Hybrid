...
def _ensure_BOT_EOT(text_tokens: Tensor, hp):
    """Ensures that the input tensor contains start and stop text tokens as specified by the hyperparameters.
    Args:
    text_tokens (Tensor): Input tensor of text tokens.
    hp: Hyperparameters containing start_text_token and stop_text_token.
    Returns:
    None
    """
...
class T3(nn.Module):
    ...
    def __init__(self, hp=None):
        """Initializes a model with hyperparameters.
        Args:
        hp (HyperParameters): Hyperparameters for the model. If None, uses default English-only settings.
        Returns:
        None
        """
        if hp is None:
    ...
    @property
    def device(self):
        """Returns the device on which the speech head weight is stored.
        Args:
        t3_cond (T3Cond): The conditioning data for T3 model.
        Returns:
        torch.device: The device of the speech head weight.
        """
    ...
    def prepare_input_embeds(
        ...
        *,
        ...
        """Prepare input embeddings for a model by combining conditional embedding, text embedding, and speech embedding.
        Args:
        ...
        cfg_weight: float, optional weight for CFG unconditioning. Default is 0.0.
        Returns:
        None
        """
    ...
    def forward(
        ...
        *,
        ...
        """Executes forward pass for the model.
        Args:
        ...
        Returns:
        embeds (torch.Tensor): Output embeddings.
        """
    ...
    def loss(
        ...
        *,
        ...
        """Computes training loss for a model.
        Args:
        t3_cond (T3Cond): Conditional input.
        text_tokens (torch.LongTensor): Tokenized text input.
        text_token_lens (torch.LongTensor): Lengths of tokenized text tokens.
        speech_tokens (torch.LongTensor): Tokenized speech input.
        speech_token_lens (torch.LongTensor): Lengths of tokenized speech tokens.
        Returns:
        None
        """
        "training method"
    ...
    def inference_turbo(self, t3_cond, text_tokens, temperature=0.8, top_k=1000, top_p=0.95, repetition_penalty=1.2,
                        max_gen_len=1000):
        """Executes inference using a turbo model to generate speech tokens based on input text and various parameters.
        Args:
        t3_cond (Tensor): Conditional input for the turbo model.
        text_tokens (Tensor): Input text tokens.
        temperature (float, optional): Sampling temperature. Defaults to 0.8.
        top_k (int, optional): Top-k filter parameter. Defaults to 1000.
        top_p (float, optional): Nucleus sampling threshold. Defaults to 0.95.
        repetition_penalty (float, optional): Repetition penalty factor. Defaults to 1.2.
        max_gen_len (int, optional): Maximum length of generated speech tokens. Defaults to 1000.
        Returns:
