...
def drop_invalid_tokens(x):
    """Drops tokens marked as SoS and EoS from a 1D or 2D array.
    Args:
    x (array-like): Input array containing token indices.
    Returns:
    array-like: Array with SoS and EoS tokens removed.
    """
    """Drop SoS and EoS"""
