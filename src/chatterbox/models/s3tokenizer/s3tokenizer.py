...
class S3Tokenizer(S3TokenizerV2):
    ...
    def __init__(
        ...
        """Initializes a speech tokenizer with the specified name and configuration.
        Args:
        name (str): The name of the tokenizer. Defaults to "speech_tokenizer_v2_25hz".
        config (ModelConfig): Configuration for the model. Defaults to ModelConfig().
        Returns:
        None
        """
        super().__init__(name)
