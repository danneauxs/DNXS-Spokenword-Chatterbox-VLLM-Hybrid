...
class T3HuggingfaceBackend(LlamaPreTrainedModel, GenerationMixin):
    ...
    def __init__(
        ...
        *,
        ...
        """Initializes a model for processing speech data.
        Args:
        - config (LlamaConfig): Configuration object for the model.
        - llama (LlamaModel): The main model component.
        - speech_enc: Speech encoding component.
        - speech_head: Speech head component.
        - latents_queue (Queue, optional): Queue for latent data. Defaults to None.
        - logits_queue (Queue, optional): Queue for logits data. Defaults to None.
        - alignment_stream_analyzer (AlignmentStreamAnalyzer, optional): Analyzer for speech alignment streams. Defaults to None.
        """
