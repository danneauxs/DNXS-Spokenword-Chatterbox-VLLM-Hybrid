...
class T3Cond:
    ...
    def save(self, fpath):
        """Saves the object's dictionary to a file using PyTorch.
        Args:
        fpath (str): The file path where the object will be saved.
        Returns:
        None
        ---
        Loads an object from a file and returns it as an instance of T3Cond.
        Args:
        fpath (str): The file path from which the object will be loaded.
        map_location (str, optional): Specifies where to load the model. Default is "cpu".
        Returns:
        T3Cond: An instance of T3Cond created from the saved data.
        """
        torch.save(self.__dict__, fpath)

    @staticmethod
    def load(fpath, map_location="cpu"):
        """Load a model from a file and initialize the T3CondEnc module.
        Args:
        fpath (str): Path to the model file.
        map_location (str, optional): Device to load the model onto. Defaults to "cpu".
        Returns:
        T3Cond: An instance of the T3Cond class initialized with the loaded model parameters.
        """
...
class T3CondEnc(nn.Module):
    ...
    def __init__(self, hp: T3Config):
        """Initializes a model with hyperparameters and sets up specific layers based on the encoder type.
        Args:
        hp (T3Config): Hyperparameters configuration for the model.
        Returns:
        None
        """
        super().__init__()
    ...
    def forward(self, cond: T3Cond):
        """Validates input conditions and processes speaker and CLAP embeddings.
        Args:
        cond: A T3Cond object containing various conditioning inputs.
        Returns:
        A tuple of processed embeddings (cond_spkr, cond_clap).
        """
        # Validate
