...
class T3Cond(nn.Module):
    ...
    def __init__(self, **kwargs):
        """Initialize T3Cond with keyword arguments, handling None values."""
        super().__init__()
    ...
    def save(self, fpath):
        """Save T3Cond object to file path."""
        torch.save(self.__dict__, fpath)

    @staticmethod
    def load(fpath, map_location="cpu"):
        """Load T3Cond object from file path."""
        kwargs = torch.load(fpath, map_location=map_location, weights_only=True)
        return T3Cond(**kwargs)
    
    def to(self, device):
        """Move T3Cond object to specified device."""
    ...
    def __repr__(self):
        """Return a string representation of T3Cond object."""
...
class T3CondEnc(nn.Module):
    ...
    def __init__(self, hp: T3Config):
        """Initialize T3CondEnc with hyperparameters and model components."""
        super().__init__()
        self.hp = hp
    ...
    def forward(self, cond: T3Cond):
        """Implement forward pass for processing condition data."""
        # Validate
