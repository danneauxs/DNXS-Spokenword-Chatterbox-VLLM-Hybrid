...
def get_num_wins(
    ...
    """Computes number of windows for given frames and step size."""
    assert n_frames > 0
...
def get_frame_step(
    ...
    """Calculates frame step based on overlap and rate."""
...
class VoiceEncoder(nn.Module):
    """Defines VoiceEncoder class inheriting from nn.Module."""
    def __init__(self, hp=VoiceEncConfig()):
        """Initializes VoiceEncoder with hyperparameters and LSTM network."""
        super().__init__()
    ...
    @property
    def device(self):
        """Returns device of current parameters."""
